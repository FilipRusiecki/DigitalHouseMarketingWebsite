    ...
    <section id="why-us" className="scroll-mt-24 bg-dh-navy py-20 text-dh-cream sm:py-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <p className="mt-5 max-w-2xl text-base leading-relaxed text-dh-cream/70 sm:text-lg">
          Marketing should be creative, strategic, and driven by results. We combine design
          craft, technology, and clear strategy so you can stand out, attract more
          customers, and build a powerful online presence.
        </p>
